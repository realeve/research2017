<template>
  <div class="wrapper">
    ...
    <div>
      <h2>调试信息</h2>
      <p style="font-weight:bold;">1.活动状态</p>
      <p>
        {{testInfo1}}
      </p>
      <p style="font-weight:bold;margin-top:30px;">2.用户身份信息</p>
      <p>
        {{testInfo2}}
      </p>
      <p style="font-weight:bold;margin-top:30px;">3.待提交信息</p>
      <p>
        {{testInfo3}}
      </p>
    </div>
...
export default {
  ...
  computed: {
    ...
    testInfo1() {
      return JSON.stringify(this.sport);
    },
    testInfo2() {
